...
export const CCTimeLine = decorate<ThisPropsType>(
...
export default connect<StateToPropsType, DispatchToPropsType>(mapStateToProps, mapDispatchToProps)(CCTimeLine);
