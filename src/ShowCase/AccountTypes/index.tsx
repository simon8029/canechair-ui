...
export const AccountTypes = decorate<ThisPropsType>(
...
export default connect<StateToPropsType, DispatchToPropsType>(mapStateToProps, mapDispatchToProps)(AccountTypes);
